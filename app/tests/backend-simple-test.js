...
import { createUserProfile, removeReview, sendNotification, updateReview } from '../imports/startup/both/Methods';
...
// test update review
Meteor.call(updateReview, "qwe890poi", { content: 'zzzz'});
// test remove review
Meteor.call(removeReview, "qwe890poi");
